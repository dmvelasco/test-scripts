...
# Declare directories
dir1="/home/dmvelasc/Projects/Prunus/Data/fastq"        # input/output directory
...
# Public sequences
# prior
#declare -a main=(SRR068360 SRR068361 SRR502982 SRR502983 SRR502984 SRR502985 SRR502986 SRR502987 SRR502990 SRR502992 SRR502994 SRR502995 SRR502997 SRR502998 SRR503000 SRR765679 SRR765838 SRR765850 SRR765861)
#declare -a abbr=(PP14 PP12 PV01 PP08 PS01 PP01 PP06 PP05 PP04 PP03 PP02 PP10 PP09 PG01 PP07 PD14 PD13 PD12 PD11)
# new
# ADD PUBLIC P. MIRA, NEW P. DAVIDIANA SEQUENCES
#declare -a main=(SRR3237762 SRR3138171 SRR3141016 SRR3141018 SRR3138115 SRR3138121 SRR3138123 SRR3138169 SRR3237746 SRR3141019 SRR3136174 SRR3136179 SRR3136181 SRR3136183 SRR765861 SRR3138129 SRR3138145 SRR3138147 SRR3141049 SRR3141073 SRR3141113 SRR3141248 SRR3138117 SRR3138168 SRR3138132 SRR3141238 SRR3141181)
...
# testing
declare -a main=(SRR068360_A SRR068360_B)
declare -a abbr=(PP14_A PP14_B)
...
fastq-mcf -t16 /home/dmvelasc/Projects/Prunus/Script/adapter.fa "$reads"_1.fastq.gz -o "$acc"_1_filt.fq.gz "$reads"_2.fastq.gz  -o "$acc"_2_filt.fq.gz
