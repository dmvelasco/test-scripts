...
LoadFunctionLibrary("UtilityFunctions.bf"); // modified from libv3/UtilityFunctions.bf; copied one directory higher
LoadFunctionLibrary("IOFunctions.bf"); // modified from libv3/IOFunctions.bv; copied one directory higher
